...
export const ROLES: Record<Rol, PerfilRol> = {
  dueno: {
    ...
    inicio: '/dueno',
    destinos: [
      { id:'resumen',   ruta:'/dueno',             nombre:'Resumen',            corto:'Inicio',   icono:ICO.casa },
      { id:'suc',       ruta:'/dueno/sucursales',  nombre:'Sucursales',         corto:'Sucursal', icono:ICO.tienda,  fase2:true },
      { id:'cortes',    ruta:'/dueno/cortes',      nombre:'Cortes del día',     corto:'Cortes',   icono:ICO.caja,    fase2:true },
      { id:'alertas',   ruta:'/dueno/alertas',     nombre:'Alertas',            corto:'Alertas',  icono:ICO.campana, fase2:true },
      { id:'reportes',  ruta:'/dueno/reportes',    nombre:'Reportes',           corto:'Reportes', icono:ICO.hoja,    fase2:true },
    ],
  },
  responsable: {
    id: 'responsable',
    ...
    inicio: '/responsable',
    destinos: [
      { id:'corte',     ruta:'/responsable',           nombre:'Mi corte',        corto:'Corte',    icono:ICO.caja },
      { id:'historial', ruta:'/responsable/historial', nombre:'Mis cortes',      corto:'Historial',icono:ICO.reloj, fase2:true },
    ],
  },
  validadora: {
    id: 'validadora',
    ...
    inicio: '/validadora',
    destinos: [
      { id:'bandeja',   ruta:'/validadora',            nombre:'Por validar',     corto:'Bandeja',  icono:ICO.check },
      { id:'validados', ruta:'/validadora/validados',  nombre:'Ya validados',    corto:'Listos',   icono:ICO.reloj, fase2:true },
    ],
  },
  egresos: {
    id: 'egresos',
    ...
    inicio: '/egresos',
    destinos: [
      { id:'nuevo',     ruta:'/egresos',              nombre:'Registrar pago',   corto:'Registrar',icono:ICO.salida },
      { id:'lista',     ruta:'/egresos/historial',    nombre:'Pagos del mes',    corto:'Pagos',    icono:ICO.reloj, fase2:true },
      { id:'prov',      ruta:'/egresos/proveedores',  nombre:'Proveedores',      corto:'Prov.',    icono:ICO.tienda, fase2:true },
    ],
  },
};
